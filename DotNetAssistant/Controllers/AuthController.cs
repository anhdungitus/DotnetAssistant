...
[Route("api/[controller]")]
    public class AuthController : ControllerBase
    {
        ...
        public async Task<IActionResult> Post([FromBody]CredentialsViewModel credentials)
        {
          ...
          var jwt = await Tokens.GenerateJwt(identity, _jwtFactory, credentials.UserName, _jwtOptions, new JsonSerializerSettings { Formatting  = Newtonsoft.Json.Formatting.Indented });
